...
-- Toggle between Gruvbox and Rose Pine.
o.bind("SUPER + SHIFT + T", "Theme toggle", "sh -c 'CURRENT=$(omarchy-theme-current); [ \"$CURRENT\" = \"Gruvbox\" ] && omarchy-theme-set \"Rose Pine\" || omarchy-theme-set \"Gruvbox\"'")

-- Disable webapp/password binds that were commented out in the previous config.
